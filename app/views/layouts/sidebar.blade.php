    ...
    <div class="side-widgets overflow">
        ...
        <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
            ...
            <ul class="dropdown-menu profile-menu">
                <li><a href="">{{ Util::ts('my_profile') }}</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                <li><a href="">{{ Util::ts('message') }}</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                <li><a href="">{{ Util::ts('setting') }}</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                <li><a href="{{ URL::route('logout') }}">{{ Util::ts('logout') }}</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
            </ul>
            <h3 class="m-0">@if (Auth::check()) {{ Auth::user()->nickname }} @else NOT LOGIN @endif</h3>
            @if (Auth::check()) {{ Auth::user()->email }} @else NOT LOGIN @endif
        </div>
