        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextCheckboxe": "必须选择这一项。",
                    "alertTextDateRange": "此为必选项。"
                },
                "requiredInFunction": { 
			...
			"func": function (field) {
			 ...
			 "alertText": "错误的日期格式。正确格式为：YYYY-MM-DD。"
                },
                "ipv4": {
                ...
                "onlyLetterSp": {
                    "regex": /^[a-zA-Z\ \']+$/,
                    "alertText": "仅允许使用大写和小写字母。"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "仅允许使用字母和数字。"
                },
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxValidateEmail": {
                	"url": "/api/validateEmail",
                	"alertText": "这个邮箱已经被使用了。",
                	"alertTextOk": "恭喜！这个邮箱竟然可以注册！",
                	"alertTextLoad": "正在验证……"
                },
                "ajaxUserCall": {
                ...
                "ajaxNameCall": {
                    ...
                    // error
                    "alertText": "这个名字已经被使用了。",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "恭喜！这个名字还没有被用掉！",
                    // speaks by itself
                    "alertTextLoad": "正在验证……"
                },
				 "ajaxNameCallPhp": {
				...
				"dateTimeFormat": {
                    ...
                    "alertText": "错误的时间格式。",
                    "alertText2": "允许的格式为：",
                    "alertText3": "mm/dd/yyyy hh:mm:ss AM|PM或者", 
